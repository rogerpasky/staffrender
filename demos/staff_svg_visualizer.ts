 ...
 * NOTE: This is a temporary solution to be further optimized meanwhile 
 * the circular references with Magenta-js/music/visualizer are solved.
 *
 * @license
...
import * as sr from '../src/staff_svg_render';
